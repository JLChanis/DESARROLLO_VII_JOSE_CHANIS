...
function estudiantes_tutoria($estudiantes){
    $estu=[];
...
function estudiantes_honor($estudiantes){
    $estu=[];
    foreach( $estudiantes as $estudiante => $info) {
        $promedio = calcularPromedio($estudiante["calificaciones"]);
        $estudiante["promedio"] = $promedio;
...
echo "\n\nEstudiantes que necesitan tutoria: ";
print_r(estudiantes_tutoria($estudiantes));

echo "\n\nEstudiantes de honor: ";
print_r(estudiantes_honor($estudiantes));
